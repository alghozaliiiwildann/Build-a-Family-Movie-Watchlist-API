...
Open the Command Palette: Press Ctrl+Shift+P on Windows and Linux or Cmd+Shift+P on Mac.
Start the Course: Search for and run freeCodeCamp: Run Course.
Select a Project: The Simple Browser tab will open. Select your desired lab or workshop from the menu to start.
